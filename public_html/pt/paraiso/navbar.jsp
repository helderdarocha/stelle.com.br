...
<HEAD>
	...
	<STYLE>
	BODY {background-color: rgb(0%,0%,0%); color: rgb(70%,70%,100%);
...
--><P class=ref><A HREF="canto_1.html">Canto 1<br>(início)</A></P><!--
<P class=ref><A HREF="cantos.html">Índice<br></A></P>
<P class=ref><A HREF="pecados.html">Índice<br>de pecados</A></P>
-->
<P class=ref><A HREF="cantos_orig.html">Poema original</A></P>
<!--
<P class=ref><A HREF="imagens.html">Imagens</A></P>-->
<P class=ref><A HREF="glossario.html">Busca</A></P>
<!--<P class=ref><A HREF="referencias.html">Referências</A></P> 
-->
<p>&nbsp;<br></p>
<p style="font-size: 11px">Copyright &copy 2000<br>Helder da Rocha</p>

<% String img_livro="par"; %>
